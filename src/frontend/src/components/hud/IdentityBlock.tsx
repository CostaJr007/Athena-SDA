...
export default function IdentityBlock({
  ...
  return (
    <div className="athena-panel pointer-events-none select-none px-3.5 py-2.5">
      <div className="flex items-center gap-2.5">
        ...
        <div>
          ...
          <p className="mt-0.5 text-[13px] uppercase tracking-[0.1em] text-zinc-400">
            Space Domain Awareness
          </p>
        </div>
      </div>
      <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-0.5 border-t border-white/10 pt-1.5 text-[13px] uppercase tracking-wider text-zinc-400">
        ...
        <span className="hidden text-zinc-400 md:inline">CelesTrak · SGP4 · IF</span>
      </div>
    </div>
  )
}
