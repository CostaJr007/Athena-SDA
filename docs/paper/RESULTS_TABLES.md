...
{'data': 'Public TLE history (~2014–2026) + GFZ F10.7/Ap/Kp', 'features': 'Keplerian + LZ76/DFA/Shannon + Page CUSUM/EWMA/BOCPD + GFZ SW', 'model': 'Isolation Forest trained on baseline+asset past windows only', 'protocol': 'Walk-forward: at each asof, fit IF on past only; score target window', 'priority_layer': 'XGB weak labels + suspect×asset pairs (not used for Claim A/B hits)', 'doctrine': 'military_first_sda', 'preregistered': True}
